    ...
    build: {
      ...
      env: {
        ...
        CSP: JSON.stringify([
          ...
          "connect-src 'self' blob: http://localhost:* https://localhost:* http://127.0.0.1:* https://127.0.0.1:* http://0.0.0.0:* https://0.0.0.0:* https://accounts.google.com https://*.google.com https://play.google.com https://api-dev.openmeet.net https://api.openmeet.net wss://api-dev.openmeet.net wss://api.openmeet.net https://*.amazonaws.com https://nominatim openstreetmap.org https://*.posthog.com https://api.hsforms.com https://localdev.openmeet.net wss://localdev.openmeet.net https://matrix-dev.openmeet.net wss://matrix-dev.openmeet.net *",
          "object-src 'none'",
          "base-uri 'self'"
        ].join('; '))
      },
