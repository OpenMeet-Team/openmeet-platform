    ...
    <q-card flat bordered>
      <q-card-section>
        ...
        <div class="row items-center justify-between q-mb-md">
          <q-btn icon="sym_r_chevron_left" flat dense round @click="previousMonth" />
          <span class="text-subtitle1">{{ currentMonthName }} {{ currentYear }}</span>
          <q-btn icon="sym_r_chevron_right" flat dense round @click="nextMonth" />
        </div>
