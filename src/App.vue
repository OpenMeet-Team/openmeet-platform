...
useMeta({
  ...
  meta: {
    description: { content: getEnv('APP_TENANT_DESCRIPTION') || 'Building communities should be easy and free. OpenMeet is a free and opensource platform for creating and managing events, groups, and communities.' },
