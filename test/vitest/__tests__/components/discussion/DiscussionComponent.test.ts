...
describe('DiscussionComponent.vue', () => {
  ...
  it('renders the component correctly', () => {
    ...
    // Just check that there's a q-card-section (which will contain NoContentComponent)
    // since the component resolution is challenging in the test environment
    expect(wrapper.find('q-card-section-stub').exists()).toBe(true)
  })
